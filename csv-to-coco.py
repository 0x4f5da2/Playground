...
class Csv2CoCo:
    ...
    def _image(self, path):
        image = {}
        print(os.path.join(self.image_dir, path))
...
if __name__ == '__main__':
    csv_file = "data/sqte/GHS-export.csv"
    image_dir = "data/sqte"
    saved_coco_path = "./"
    # 整合csv格式标注文件
    ...
    for file in train_keys:
        shutil.copy(os.path.join(image_dir, file), "%scoco/images/train2017/" % saved_coco_path)
    for file in val_keys:
        shutil.copy(os.path.join(image_dir, file), "%scoco/images/val2017/" % saved_coco_path)
    # 把验证集转化为COCO的json格式
